...
function kaartenUitschakelen(){
    ...
    var deAudio = document.getElementById("tweeKaartenSfx");
...
function winnaarsmuziek(){
    console.log("in winnaarsmuziek");
    var audioelm=document.getElementById("gangsterforlife");
